...
require (
	...
	github.com/openshift/client-go v0.0.0-20190401163519-84c2b942258a // indirect
	...
	k8s.io/client-go v0.0.0-20190228174230-b40b2a5939e4 // indirect
	k8s.io/klog v0.3.3 // indirect
	k8s.io/klog/v2 v2.2.0 // indirect
	k8s.io/kube-openapi v0.0.0-20230501164219-8b0f38b5fd1f // indirect
	kubevirt.io/containerized-data-importer v1.8.1-0.20190516083534-83c12eaae2ed // indirect
